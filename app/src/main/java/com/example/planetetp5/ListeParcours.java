...
public class ListeParcours extends Fragment implements DetecteurDeClicSurRecycler{
    ...
    public View onCreateView(
        ...
        View view = inflater.inflate(R.layout.liste_parcours, container, false);
        ...
        mAdapter = new MonRecyclerViewAdapterParcours(getDataSource());
