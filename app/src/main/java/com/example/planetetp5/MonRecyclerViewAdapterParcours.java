...
public class MonRecyclerViewAdapterParcours extends RecyclerView.Adapter<com.example.planetetp5.MonRecyclerViewAdapterParcours.ConteneurDeDonnee> {
    private ArrayList<com.example.planetetp5.Donnee> donnees;
    private DetecteurDeClicSurRecycler detecteurDeClicSurRecycler;

    public MonRecyclerViewAdapterParcours(ArrayList<com.example.planetetp5.Donnee> donnees) {
    ...
    public void onBindViewHolder(ConteneurDeDonnee conteneur, int position) {
        ...
        conteneur.categorie.setText(donnees.get(position).getTailles());
    ...
    public static class ConteneurDeDonnee extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ConteneurDeDonnee(View itemView) {
            super(itemView);
            titre = (TextView) itemView.findViewById(R.id.parcours_nom);
